            ...
            <div class="row">
                <div class="event-items">
                    ...
                    <div class="item horizontal col-md-12">
                        <div class="col-md-6 thumb bg-cover" style="background-image: url(frontend/assets/img/event/1.jpg);">
                            <div class="date">
                    ...
                    <div class="item vertical col-md-6">
                        <div class="thumb">
                            <img src="{{ asset('frontend/assets/img/event/2.jpg') }}" alt="Thumb">
                            <div class="date">
                    ...
                    <div class="item vertical col-md-6">
                        <div class="thumb">
                            <img src="{{ asset('frontend/assets/img/event/3.jpg') }}" alt="Thumb">
                            <div class="date">
                    ...
                    <!-- Single Item -->
                    <div class="item horizontal col-md-12">
                        <div class="col-md-6 thumb bg-cover" style="background-image: url(frontend/assets/img/event/4.jpg);">
                            <div class="date">
